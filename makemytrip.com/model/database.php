...
$result = $conn->query("SELECT * FROM  $table");
 ...
 function CheckLoc1($conn,$table,$username,$loc)
 {
  $result = $conn->query("SELECT * FROM  $table WHERE username='$username' AND pick LIKE '%$loc%' ");
  return $result;
 }
 ...
 function UpdateCost($conn,$table,$username,$vehicle,$pick,$destination,$cost)
 {
  $result = $conn->query("UPDATE $table SET cost='$cost' WHERE username='$username' AND vehicle='$vehicle' AND pick='$pick' AND destination='$destination' ");
  return $result;
 }
