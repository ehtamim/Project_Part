...
<body>
    ...
    <br> <br>
    <a href="providedservice.php"> <input name="services" type="submit" id="click" value="SERVICE INFORMATION">
    </a>
    <br> <br>
    ...
    <a href="/logout"> <input name="logOut" type="submit" id="click" value="LOG OUT"> </a>
    <br>
    <br>
    </div>
</body>
...
<?php /**PATH C:\xampp\htdocs\profileUpdate\resources\views/dashboard.blade.php ENDPATH**/ ?>