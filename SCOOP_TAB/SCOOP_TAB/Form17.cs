...
namespace SCOOP_TAB
{
    public partial class Form17 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into manager_tbl values(@id,@name,@username,@pass,@location,@salary,@img)";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "select * from manager_tbl";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "update manager_tbl set id=@id, name=@name, username=@username,pass=@pass,location=@location,salary=@salary,pic=@img where id=@id";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@id", textBox1.Text);
            cmd.Parameters.AddWithValue("@name", textBox2.Text);
            cmd.Parameters.AddWithValue("@username", textBox3.Text);
